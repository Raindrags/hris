...
export default function AdminFormCutiPage() {
  ...
  const handleSelectUser = async (userId: string) => {
    ...
    try {
      ...
      const data = await res.json();
      setUserDetail(data.data || data.user || { sisaCuti: 0 });
    } catch {
      setUserDetail({ sisaCuti: 0 });
    }
  };
      ...
      <Card className="bg-gray-900 border-gray-800 shadow-md">
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-white">
            ...
            Pengajuan Cuti untuk Pegawai
          </CardTitle>
          <CardDescription className="text-gray-400">
            Pilih pegawai yang akan diajukan cuti, lalu klik tombol Ajukan untuk
            mengisi form.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          {selectedUser && !showForm && (
            ...
            >
              ...
              Ajukan Cuti untuk {selectedUser.name}
            </Button>
          )}
